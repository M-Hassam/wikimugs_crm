...
class QaAssignOrderController extends Controller
{
    /**
    ...
    public function index()
    {
        if(auth()->check()){
            ...
            ->where('status_id',4)
            ->get();
            return view('qawriters.delivered.index',$data);
        }else{
            abort(404);
        }
    }
    ...
    {
        $data['model'] = Order::with('files')->find($id);
        return view('qawriters.delivered.add_edit',$data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('qawriters.assigned.index')->with('success','Status updated successfully');
    }
