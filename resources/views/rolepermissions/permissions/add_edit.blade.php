                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <div class="preview-block">
                                <span class="preview-title-lg overline-title">@if(isset($model) && $model->id) Edit @else Add @endif Permission</span>
                                @if(isset($model))
                                <form action="{{ route('permissions.update',['permission'=>$model->id]) }}" method="post">
                                    @method('PUT')
                                    @else
