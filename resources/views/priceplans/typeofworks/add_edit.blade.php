                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <div class="preview-block">
                                <span class="preview-title-lg overline-title">@if(isset($model) && $model->id) Edit @else Add @endif Price plan type of work</span>
                                @if(isset($model))
                                <form action="{{ route('priceplan.type-of-works.update',['type_of_work'=>$model->id]) }}" method="post">
                                    @method('PUT')
                                    @else
                                    <form action="{{ route('priceplan.type-of-works.store') }}" method="post">
                                        @endif
                                        @csrf
                                        {{-- <div class="row">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="{{ route('priceplan.type-of-works.index') }}" class="btn btn-success"> Back</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
