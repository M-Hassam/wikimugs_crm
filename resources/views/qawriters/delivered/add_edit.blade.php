                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <div class="preview-block">
                                ...
                                @if(isset($model))
                                <form action="{{ route('writersqa.orders.update',['order'=>$model->id]) }}" method="post" enctype="multipart/form-data">
                                    @method('PUT')
                                    @else
                                    <form action="{{ route('writersqa.orders.store') }}" method="post" enctype="multipart/form-data">
                                        @endif
                                        @csrf
                                        {{-- <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <select name="lead_status_id" class="form-control">
                                                            <option value="6">Completed/Approved</option>
                                                            <option value="5">Re Assign</option>
                                                        </select>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-8">Add order files
                                                <div class="form-group">
                                                    @if(isset($model['files']) && count($model['files']))
                                                    @foreach($model['files'] as $file)
                                                    <a href="{{ asset('uploads/files/'.$file->file) }}">View File</a>
                                                    @endforeach
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="{{ route('writersqa.orders.index') }}" class="btn btn-success"> Back</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
