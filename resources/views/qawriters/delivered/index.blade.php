                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">QA Delivered Orders</h3>
                                <div class="nk-block-des text-soft">
                                    <p>Under this section you will find the list of all delivered orders</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                        ...
                                        <td>{{ $model->deadline_date ?? "---" }} {{ $model->deadline_time ?? "---" }}</td>
                                            <td>
                                                <div class="action-buttons">
                                                    <a class="ml-1" href="{{ route('writersqa.orders.edit',['order'=>$model->id]) }}" title="Update" data-toggle="tooltip">
